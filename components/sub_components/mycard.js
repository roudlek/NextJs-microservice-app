...
export default function MyCard(){
    return(
        <>
            ...
            <Image src="/images/Abdelaziz_el_idrissi.jpg" className="rounded-full m-6" height={144} width={144} alt="Abdelaziz el idrissi's profile picture" />
            <h2 className="text-3xl font-semibold text-center text-blue-600 my-2">{name.toUpperCase()}</h2>
            <p className="text-gray-600 text-center font-mono text-lg">Full Stack Web Developer</p>
            </div>
